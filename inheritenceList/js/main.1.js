...
*
*  – Модули в виде Self-Executing Anonymous Functions - 0.5
*  – Работа с шаблоном и событиями в целом - 1
*  – Дублирование массива с данными - 1.5
*  – Работа preventDefault(). - 0.5 
*  – Пейджинг, кнопка "Далее" - 3
*  – Выбор всех элементов списка - 1.5
*  – Выбор одного элемента списка - 1
*  – Фильтрация элементов - 3
*  – Сортировка элементов - 2
*  – Поиск элементов по имени - 4
*  – Работа с функцией Reduce - 1
*  – Кастомные data атрибуты - 0.5
*  – Работа с разными View - 1
*  – Отображение полной информации об элементе - 2
*  - Всего 22 часа, около 3 дней
*/
(function(){
